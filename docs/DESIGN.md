...
> Design notes for **private-order-document-search** — a runnable typescript example that A typed service that embeds and searches privacy-scoped checkout, fulfillment, receipt, and order update documents.
...
- **Feature code** — the actual task: private-order-search.
